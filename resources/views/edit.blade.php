                    ...
                    <div class="col-md-12 p-0 d-md-flex">
                        <div class="col-md-8  ">
                            <div class="form-group d-flex">
                                ...
                                <input type="text" name="name" value="{{ old('name', $member->name) }}" class="form-control form-control-sm " ><br>
                            </div>
                            <div class="form-group d-flex">
                                <label for="dateofbirth"class="col-md-3 p-0">Date of Birth:</label>
                                <input type="date"value="{{ old('dateofbirth', $member->dateofbirth) }}"class="form-control form-control-sm " name="dateofbirth" ><br>
                                @error('dateofbirth') <span class="text-danger">{{ $message }}</span> @enderror

                            </div>
                            <div class="form-group d-flex">
                                <label for="address" class="col-md-3 p-0">Address:</label>
                                <input type="text" value="{{ old('address', $member->address) }}"class="form-control form-control-sm " name="address" ><br>
                                @error('address') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            <div class="form-group d-flex">
                                <label for="mobileno"class="col-md-3 p-0">Mobile No:</label>
                                <input type="text" value="{{ old('mobileno', $member->mobileno) }}" class="form-control form-control-sm" name="mobileno" ><br>
