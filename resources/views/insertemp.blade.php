...
<main id="main" class="main">
    ...
    <div class="card-body ">
        <form action="{{ route('insertemp.submit') }}" onsubmit="return validate()" name="myForm" method="POST">
            @csrf
                ...
                <div class="col-md-12 p-0 d-flex">
                    <div class="col-md-6 pt-1">
                        <div class="form-group d-flex">
                            ...
                            <input type="text" class="form-control form-control-sm" name="emp_name"><br>
...
{{--
                        ...
                        <div class="form-group d-flex">
                            ...
                            <input type="text" class="form-control form-control-sm" name="phone" ><br>
                        ...
                        <div class="form-group d-flex">
                            ...
                            <textarea id="w3review" name="address" rows="4" cols="50"  class="form-control form-control-sm" ></textarea>
                    ...
                    <div class="col-md-6 pt-1">
                        <div class="form-group d-flex">
                            ...
                            <input type="email" name="email"class="form-control form-control-sm" ><br>
                        ...
                        <div class="form-group d-flex">
                            ...
                            <input type="text" name="salary"class="form-control form-control-sm select2" ><br>
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="checkbox-group">
                                <input type="checkbox" id="hobbies1" name="hobbies[]" value="Reading books">
                                <label for="hobbies1">Reading Books</label>
                            </div>
                            <div class="checkbox-group">
                                <input type="checkbox" id="hobbies2" name="hobbies[]" value="Playing Carrom">
